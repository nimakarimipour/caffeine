...
public final class Caffeine<K, V> {
  ...
  public <K1 extends K, V1 extends V> Caffeine<K1, V1> weigher(
       @Nullable Weigher<? super K1, ? super V1> weigher) {
  ...
  public Caffeine<K, V> refreshAfterWrite(@Nonnegative long duration,  @Nullable TimeUnit unit) {
    requireNonNull(unit);
  ...
  public <K1 extends K, V1 extends V> Caffeine<K1, V1> writer(
       @Nullable CacheWriter<? super K1, ? super V1> writer) {
  ...
  public <K1 extends K, V1 extends V> AsyncLoadingCache<K1, V1> buildAsync(
       @Nullable AsyncCacheLoader<? super K1, V1> loader) {
